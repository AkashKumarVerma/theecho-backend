...
const UserSchema = new mongoose.Schema({
  ...
  articles : [{ type: mongoose.Schema.Types.ObjectId, ref: 'EditorArticles'}],
  drafts   : [{ type: mongoose.Schema.Types.ObjectId, ref: 'EditorDrafts'}],
  liked    : [{ type: mongoose.Schema.Types.ObjectId, ref: 'EditorArticles'}]
}, {
  timestamps: true
})
